...
eeg = double(readNPY('/media/thanos/Elements/thanos/sim_data/sim_type_1/downsampled_dipoles-25k/1e-15/eeg_2TeD.npy'));
...
close(w_bar);
save('/media/thanos/Elements/thanos/sim_data/sim_type_1/downsampled_dipoles-25k/1e-15/eeg_2TeD_topos.mat', 'eeg_topos', '-v7.3')
save('/media/thanos/Elements/thanos/sim_data/sim_type_1/downsampled_dipoles-25k/1e-15/eeg_2TeD_topos_xi.mat', 'eeg_Xi', '-v7.3')
save('/media/thanos/Elements/thanos/sim_data/sim_type_1/downsampled_dipoles-25k/1e-15/eeg_2TeD_topos_yi.mat', 'eeg_Yi', '-v7.3')
