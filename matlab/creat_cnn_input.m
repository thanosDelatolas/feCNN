...
eeg = double(readNPY('../../../Downloads/snr_15/eeg.npy'));
...
save('../../../Downloads/snr_15/eeg_topos.mat', 'eeg_topos', '-v7.3');
save('../../../Downloads/snr_15/eeg_topos_xi.mat', 'eeg_Xi', '-v7.3');
save('../../../Downloads/snr_15/eeg_topos_yi.mat', 'eeg_Yi', '-v7.3');
